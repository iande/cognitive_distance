...
module CognitiveDistance
  describe Transforms::CallTreeToModuleBoundaryGraph do
    before do
      @transformer = Transforms::CallTreeToModuleBoundaryGraph.new
    ...
    it "provides a singleton convenience method" do
      ...
      graph2 = Transforms::CallTreeToModuleBoundaryGraph.transform(@tree)
